...
class AccountingReport(models.TransientModel):
    ...
    date_from_cmp = fields.Date(string='Select Start Date')
    date_to_cmp = fields.Date(string='Select End Date')
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('flexibite_com_advance.action_report_financial').report_action(self, data=data,
                                                                                           config=False)
