...
class sales_details_pdf_template(models.AbstractModel):
    ...
    #     report = report_obj._get_report_from_name('flexibite_com_advance.sales_details_pdf_template')
    #     docargs = {
    ...
    #         'data': data
    #     }
    #     return report_obj.render('flexibite_com_advance.sales_details_pdf_template', docargs)
