...
//            this.controlPanelParams({withSearchBar: true}, {searchMenuTypes: true});
        },
        ...
        onchange_week_option : function(company_id, option){
            ...
            var first = moment().day("Sunday").week(select_week).locale('en').format('YYYY-MM-DD');
            var last = moment().day("Saturday").week(select_week).locale('en').format('YYYY-MM-DD');
